...
async def upload_image(file: UploadFile = File(...), project_id: Optional[int] = Form(None), payload: UserPayloadData = Security(verify_current_user)):
...
async def delete_image(image_id: int, payload: UserPayloadData = Security(verify_current_user)):
