...
from api.endpoints import auth, users, projects, comments, tags, ratings, notifications, favorites, images
...
# 图片路由
router.include_router(images.router, prefix="/images", tags=["图片"])
